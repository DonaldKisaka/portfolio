    ...
    <div className='flex flex-col w-full mt-24'>
        ...
        <div className='flex flex-col w-full'>
            <div className='flex items-start gap-8'>
                <div className='rounded-lg w-[640px] border border-[#D3D3D3]/50 p-5 flex flex-col gap-5'>
                  <Link target='_blank' aria-label='See more about philip&apos;s website' href="https://pkw.finance/">
                    <Image src="/philipswebsite.png" alt="project screenshot" loading='lazy' width={600} height={380} className='rounded-md object-cover text-transparent'/> 
                  </Link>
                  <div className='flex flex-col'>
                    ...
                    <div className='grid grid-cols-4 max-sm:grid-cols-3 max-[500px]:grid-cols-2 items-center gap-2 mt-5'>
                        ...
                        <div className='flex items-center gap-2 w-full max-md:flex-col'>
                            <Link target='_blank' className='w-full bg-gray-500 h-6 uppercase text-xs whitespace-nowrap transition-all hover:bg-gray-800 rounded-full font-bold text-white flex items-center justify-center px-4 py-2 gap-2 max-md:w-full' href="https://github.com/DonaldKisaka/PKW-corporate">
            ...
            <div className='flex items-start gap-8 mt-10'>
                <div className='rounded-lg w-[640px] border border-[#D3D3D3]/50 p-5 flex flex-col gap-5'>
                  <Link target='_blank' aria-label='See more about philip&apos;s website' href="https://furniture-app-utbp.vercel.app/">
                    <Image src="/RenoTzy.png" alt="project screenshot" loading='lazy' width={600} height={380} className='rounded-md object-cover text-transparent'/> 
                  </Link>
                  <div className='flex flex-col'>
                    ...
                    <div className='flex h-6 items-center justify-center gap-1.5 px-4 rounded-full bg-white/20 text-white'>
                        ...
                        <div className='flex items-center gap-2 w-full max-md:flex-col'>
                            <Link target='_blank' className='w-full bg-gray-500 h-6 uppercase text-xs whitespace-nowrap transition-all hover:bg-gray-800 rounded-full font-bold text-white flex items-center justify-center px-4 py-2 gap-2 max-md:w-full' href="https://github.com/DonaldKisaka/furniture-app">
                            <Image src="/github-icon.svg" loading="lazy" alt="GitHub" width={20} height={20} className="text-transparent"/>
                            Source code
                            </Link>
                        </div>
            ...
            <div className='flex items-start gap-8 mt-10'>
                <div className='rounded-lg w-[640px] border border-[#D3D3D3]/50 p-5 flex flex-col gap-5'>
                  <Link target='_blank' aria-label='See more about philip&apos;s website' href="https://insyc.vercel.app/">
                    <Image src="/Insync.png" alt="project screenshot" loading='lazy' width={600} height={380} className='rounded-md object-cover text-transparent'/> 
                  </Link>
                  <div className='flex flex-col'>
                    ...
                    <div className='flex h-6 items-center justify-center gap-1.5 px-4 rounded-full bg-white/20 text-white'>
                        ...
                        <div className='flex items-center gap-2 w-full max-md:flex-col'>
                            <Link target='_blank' className='w-full h-6 bg-gray-500 uppercase text-xs whitespace-nowrap transition-all hover:bg-gray-800 rounded-full font-bold text-white flex items-center justify-center px-4 py-2 gap-2 max-md:w-full' href="https://github.com/DonaldKisaka/Insyc">
                            <Image src="/github-icon.svg" loading="lazy" alt="GitHub" width={20} height={20} className="text-transparent"/>                
                            Source code
                            </Link>
                        </div>
